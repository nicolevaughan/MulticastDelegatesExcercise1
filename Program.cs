namespace MulticastDelegatesExcercise1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Program.Song herecomesthesunObj = new Program.Song(HereComesTheSun.title);
            herecomesthesunObj += HereComesTheSun.chorus;
            herecomesthesunObj += HereComesTheSun.verse1;
            herecomesthesunObj += HereComesTheSun.chorus;
            herecomesthesunObj += HereComesTheSun.verse2;
            herecomesthesunObj += HereComesTheSun.chorus2;
            herecomesthesunObj += HereComesTheSun.verse3;
            herecomesthesunObj += HereComesTheSun.chorus;
            herecomesthesunObj += HereComesTheSun.chorus;
            herecomesthesunObj += HereComesTheSun.end;
